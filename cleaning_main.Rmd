...
correlation.matrix <- cor(data_en[,c("Eg.SCM","Es.SCM","Ec.SCM", "Eg.SSM", "Es.SSM", "Ec.SSM")], use = "pairwise.complete.obs")
stargazer(correlation.matrix, title="Correlation Matrix", type = "text", out="table1.txt")
