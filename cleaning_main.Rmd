...
demog <- data_en.complete[demovar]
...
# Table S1 on sample characteristics of the first 5000 complete Europeans

# Table S6 of intercorrelations between included covariates (not all) and the hypothesized resilience factors (can also be a correlation matrix) in the cleaned complete Europeans
